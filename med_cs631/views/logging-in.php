...
<?php
	...
	$emp_type_patient = "false";
	$emp_type_employee = "false";
		...
		if(isset($_REQUEST["emp-type"])) {
			...
			if(isset($emp_type_employee) && (!isset($emp_type_user[0]) || $emp_type_employee !== $emp_type_user[0]) && (!isset($emp_type_user[1]) || $emp_type_employee !== $emp_type_user[1])) {
				...
				<p id="spec-match-not">Our records indicate that your specialty does not match the specialty you logged in as. Would you like to
					<a id="keep-logging-in" href="" user="<?php echo $username; ?>" pass="<?php echo $password; ?>" patient="<?php echo $emp_type_patient; ?>" emptype="<?php echo $emp_type_employee; ?>">keep logging in with your reported specialty</a>, <a href="mailto:admin@med.cs631" id="login-change">contact the admin to change your
				...
				?>
				<div id="page" user="<?php echo $username; ?>" pass="<?php echo $password; ?>" patient="<?php echo $emp_type_patient; ?>" emptype="<?php echo $emp_type_employee; ?>"></div>
				<?php
			}
		}
		else {
