	...
	<table id="hor-minimalist-b" summary="Final Data">
		...
		<tbody>
	    	<tr>
				...
				<td>0 out of 13</td>
	        	<td>0%</td>
				<td>Need to meet 13 more core requirements</td>
			...
			<tr>
				...
				<td>0 out of 8</td>
	        	<td>0%</td>
				<td>Need to meet 4 more menu requirements</td>
			...
			<tr>
				...
				<td>0 out of 2</td>
	        	<td>0%</td>
				<td>Need to meet at least one public
				health requirement out of the last two</td>
			...
			<tr>
				...
				<td colspan="3">You still have a gap</td>
	...
	<table id="hor-minimalist-b" summary="Survey Data">
		...
		<tbody>
				...
				<tr>
					...
					information subject to the EP’s discretion to withhold certain information.</td>
		            <td>Empty</td>
					<td>10%</td>
